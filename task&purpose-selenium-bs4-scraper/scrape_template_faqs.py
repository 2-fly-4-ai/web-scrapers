...
with open('task_purpose_dataset_FAQS.csv', 'w', newline='', encoding="utf-8") as csvfile:
...
for i in x:
    ...
    with open('task_purpose_dataset_FAQS.csv', 'a+', newline='', encoding="utf-8") as csvfile:
        csvwriter = csv.writer(csvfile)
